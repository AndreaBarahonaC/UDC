...
```
![](graficos/effectplot.png){width=260}

```{r eval=FALSE}
interactionPlot(dfac)
```
![](graficos/interactionplot.png){width=260}
...
![](graficos/dfac2plots.png){width=260}
